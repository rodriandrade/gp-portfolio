    ...
    return(
        <div>
            ...
            <Grid colGap={40} rowGap={20}>
                <Col desktop={4} tablet={6} mobile={12} order={1}>
                    <ContentContainer>
                ...
                <Col desktop={4} tablet={6} mobile={12} order={2}>
                    <ContentContainer>
                        <Icon src="/idea.svg"/>
                ...
                <Col desktop={4} tablet={6} mobile={12} order={3}>
                    <ContentContainer>
                ...
                <Col desktop={4} tablet={6} mobile={12} order={4}>
                    <ContentContainer>
                ...
                <Col desktop={4} tablet={6} mobile={12} order={5}>
                    <ContentContainer>
                        <Icon src="/radio.svg"/>
                ...
                <Col desktop={4} tablet={6} mobile={12} order={6}>
                    <ContentContainer>
                        <Icon src="/writer.svg"/>
